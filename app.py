...
DEFAULT_CONFIG = {
    "site_title": "TAMIM VPS",
    "site_header": "TAMIM VPS",
    ...
    "passwords": {
        "secret": hashlib.sha256("TAMIM567".encode()).hexdigest(),
...
async def api_check(message: types.Message):
    ...
    try:
        ...
        r = requests.get(url, timeout=15, headers={
            'User-Agent': 'Mozilla/5.0 (TAMIM VPS Bot)'
        })
...
if __name__ == "__main__":
    ...
    print("  Secret: TAMIM VPS (Can change user password)")
